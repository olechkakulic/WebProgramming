...
function drawTime() {
    ...
    drawHand(clockRadius * 0.5, hoursAngle, 8, '#FFF');

    // Рисуем минутную стрелку
    drawHand(clockRadius * 0.7, minutesAngle, 6, '#FFF');

    // Рисуем секундную стрелку
    drawHand(clockRadius * 0.9, secondsAngle, 3, '#9b2b07');
...
// Обновляем часы каждые 7 секунд
